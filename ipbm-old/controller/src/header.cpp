...
Header::Header(uint32_t header_id, int32_t header_length,
...
void Header::addField(Field field) { this->fields.push_back(field); }

std::vector<Field>* Header::getField() { return &(this->fields); }
...
uint32_t Header::getHeaderId() const { return this->header_id; }

void Header::setHeaderId(uint32_t headerId) { this->header_id = headerId; }

int32_t Header::getHeaderLength() const { return this->header_length; }

void Header::setHeaderLength(int32_t headerLength) {
    this->header_length = headerLength;
}

const std::string& Header::getHeaderName() const { return this->header_name; }
