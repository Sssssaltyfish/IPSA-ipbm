...
public:
    ...
    GenericRegex(const Ch* source, Allocator* allocator = 0)
        : ownAllocator_(allocator ? 0 : RAPIDJSON_NEW(Allocator)()),
          ...
          root_(kRegexInvalidState), stateCount_(), rangeCount_(),
...
private:
    ...
    bool EvalQuantifier(Stack<Allocator>& operandStack, unsigned n,
                        unsigned m) {
...
public:
    ...
    GenericRegexSearch(const RegexType& regex, Allocator* allocator = 0)
        ...
        stateSet_ =
            static_cast<unsigned*>(allocator_->Malloc(GetStateSetSize()));
...
private:
    ...
    template <typename InputStream>
    bool SearchWithAnchoring(InputStream& is, bool anchorBegin,
                             bool anchorEnd) {
