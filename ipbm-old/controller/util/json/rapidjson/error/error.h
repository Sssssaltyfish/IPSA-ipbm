...
enum ValidateErrorCode {
    ...
    kValidateErrorExclusiveMinimum, //!< Number is less than or equal to the
                                    //!< 'minimum' value.
    ...
    kValidateErrorMaxProperties, //!< Object has more members than
                                 //!< 'maxProperties' value.
    kValidateErrorMinProperties, //!< Object has less members than
                                 //!< 'minProperties' value.
    kValidateErrorRequired, //!< Object is missing one or more members required
                            //!< by the schema.
    ...
    kValidateErrorEnum, //!< Property has a value that is not one of its allowed
                        //!< enumerated values
