...
public:
     ...
     * back during serialization, \c false to discard comments. This parameter
     * is ignored if Features::allowComments_ is \c false. \return \c true if
     * the document was successfully parsed, \c false if an error occurred.
     */
