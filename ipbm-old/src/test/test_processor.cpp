...
int main() {
    ...
    proc_fwd.executor = TestRouter::build_executor_forward(
        ACT_NONE_ID, ACT_FWD_ID, HDR_IP_ID, HDR_ETHER_ID);
    ...
    uint8_t packet[] =
        ...
        "\x45\x00\x00\x14\x00\x01\x00\x00\x40\x00\x63\x86\x0a\x00\x01\x32\x0a"
        "\x00\x02\x32";
