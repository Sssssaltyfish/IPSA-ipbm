...
int main() {
    ApiRouter::build();
    {
        ...
        uint8_t packet[] =
            "\xc0\xb4\x7d\x99\xa0\xa0\xc8\x58\xc0\xb5\xfe\x1e\x08\x00\x45\x00"
    ...
    }
    {
        ...
        uint8_t packet[] =
            "\xff\xff\xff\xff\xff\xff\xc0\xb4\x7d\x99\xa0\xa0\x08\x06\x00\x01"
...

    {
        // test hit
        uint8_t packet[] =
            "\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x01\x50\x08\x00"
            "\x45\x00\x00\x14\x00\x01\x00\x00\x40\x00\x63\x86\x0a\x00\x01\x32"
            "\x0a\x00\x02\x32";
        int len = sizeof(packet) - 1;
