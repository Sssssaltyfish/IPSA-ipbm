...
public:
    ...
    static void build() {
        ...
        int TAB_MAC_ID = 0;
        set_flow_table(
            TAB_MAC_ID, 0, MEM_SRAM, MATCH_EXACT,
        ...
        set_executor(PROC_FWD_ID, ACT_L2_FWD_ID, Processor::PROC_ID_END,
                     ACT_L2_BCAST_ID, Processor::PROC_ID_END,
                     runtime_args_spec);
        ...
        // ----- INSERT FLOW ENTRY -----
        {
            ...
            flow1.action_data = {std::string((char*)&port1, sizeof(uint32_t))};
            assert(add_flow_entry(MEM_SRAM, TAB_MAC_ID, flow1) == 0);
            auto flow1_buf =
                get_flow_entry_val(TAB_MAC_ID, (Buffer)flow1.key.c_str());
        ...
        }
        {
            ...
            flow2.action_data = {std::string((char*)&port2, sizeof(uint32_t))};
        ...
        }
        {
            ...
            flow3.action_data = {std::string((char*)&port3, sizeof(uint32_t))};
        ...
        }
        {
            ...
            flow4.action_data = {std::string((char*)&port4, sizeof(uint32_t))};
