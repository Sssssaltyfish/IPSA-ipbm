...
public:
    virtual bool isBitType() const { return false; }
...
public:
    int length;
    virtual bool isBitType() const { return true; }
...
public:
    std::string name;
    virtual bool isNamedType() const { return true; }
    virtual std::string toString() const { return "class<" + name + ">"; }
