...
public:
    ...
    virtual std::string toString() const { return "field-def(" + name + ")"; }
...
public:
    ...
    Rp4Member(std::string _instance_name, std::string _member_name)
        : instance_name(std::move(_instance_name)),
...
public:
    ...
    Rp4Field() {}
    Rp4Field(std::string _instance_name, std::string _member_name,
