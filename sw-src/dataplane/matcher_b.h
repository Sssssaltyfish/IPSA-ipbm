...
public:
    ...
    void set_sram_config(int key_width, int value_width, int depth,
                         const uint8_t* key_config,
                         const uint8_t* value_config) {
    ...
    void insert_entry(uint8_t* key, uint8_t* value, int key_byte_len,
        ...
        for (int i = 0; i < sram_slice_value_width; i++) {
            sram_value_seq[i] =
                sram_value_config[slice_idx + sram_slice_depth * i];
        }
    ...
    void get_match_res(
        const uint8_t* match_key, LEN key_len, uint8_t* out_key,
        uint8_t* out_value) { //, uint8_t * out_key, uint8_t * out_value
...
public:
    ...
    void insert_entry(int matcher_id, uint8_t* key, uint8_t* value,
    ...
    void set_sram_config(int matcher_id, int key_width, int value_width,
                         int depth, uint8_t* key_config,
                         uint8_t* value_config) {
        mts[matcher_id]->set_sram_config(key_width, value_width, depth,
