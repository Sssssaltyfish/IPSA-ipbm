...
public:
    ...
    RC mod_parser_entry(int proc_id, int parser_level, int state,
                        uint32_t entry, uint32_t mask, int hdr_id, int hdr_len,
                        int next_state, int trans_fd_num,
                        std::vector<FieldInfo*> trans_fds, uint8_t miss_act) {
    ...
    static rp4::GateEntryType get_gate_entry_type(GateEntryType get) {
        ...
        case GateEntryType::TABLE:
            return rp4::GateEntryType::TABLE;
        case GateEntryType::STAGE:
            return rp4::GateEntryType::STAGE;
        default:
            break;
        }
    }
    ...
    RC set_default_gate_entry(int proc_id, GateEntryType type, int value) {
        ...
        Status status =
            stub_->setDefaultGateEntry(&context, request, &response);
        if (status.ok())
            return 1;
        else
            return 0;
    ...
    RC set_action_proc(int proc_id, int matcher_id,
    ...
    static rp4::MatchType get_match_type(MatchType mt) {
        ...
        case MatchType::EXACT:
            return rp4::MatchType::EXACT;
        case MatchType::LPM:
            return rp4::MatchType::LPM;
        case MatchType::TERNARY:
            return rp4::MatchType::TERNARY;
        default:
            break;
        }
    }

    RC set_mem_config(int proc_id, int matcher_id, int key_width,
                      int value_width, uint8_t* keyConfig, uint8_t* valueConfig,
                      MatchType match_type, int depth, int miss_act_id) {
    ...
    RC set_field_info(int proc_id, int matcher_id,
    ...
    //            ClientContext context;
    //
    //            Status status = stub_->setHitMissBitmap(&context, request,
    //            &response);
    //
    ...
    //            ClientContext context;
    //
    //            Status status = stub_->setHitActId(&context, request,
    //            &response);
    //
    //            if(status.ok()) return 1;
    //            else return 0;
    ...
    RC insert_tcam_entry(int proc_id, int matcher_id, uint8_t* key,
                         uint8_t* mask, uint8_t* value, int key_byte_len,
                         int value_byte_len) {
    ...
    RC insert_action(int proc_id, int action_id, int para_num,
...
private:
    static rp4::FieldType get_field_type(const FieldType& field_type) {
        ...
        case FieldType::VALID:
            return rp4::FieldType::VALID;
        case FieldType::FIELD:
            return rp4::FieldType::FD;
        case FieldType::HIT:
            return rp4::FieldType::HIT;
        case FieldType::MISS:
            return rp4::FieldType::MISS;
        default:
            break;
        }
        return rp4::FieldType::FD;
    ...
    static rp4::RelationCode get_relation_code(RelationCode rc) {
        ...
        case RelationCode::GT:
            return rp4::RelationCode::GT;
        case RelationCode::GTE:
            return rp4::RelationCode::GTE;
        case RelationCode::LT:
            return rp4::RelationCode::LT;
        case RelationCode::LTE:
            return rp4::RelationCode::LTE;
        case RelationCode::EQ:
            return rp4::RelationCode::EQ;
        case RelationCode::NEQ:
            return rp4::RelationCode::NEQ;
        default:
            break;
        }
    }
    ...
    rp4::ParameterType get_parameter_type(ParameterType pt) {
        ...
        case ParameterType::FIELD:
            return rp4::ParameterType::FIELD;
        case ParameterType::CONSTANT:
            return rp4::ParameterType::CONSTANT;
        case ParameterType::PARAM:
            return rp4::ParameterType::PARAM;
        case ParameterType::OPERATOR:
            return rp4::ParameterType::OPERATOR;
        default:
            break;
        }
    }
    ...
    static rp4::OpCode get_op_code(const OpCode& op) {
        switch (op) {
        case OpCode::ADD:
            return rp4::OpCode::ADD;
        case OpCode::SUB:
            return rp4::OpCode::SUB;
        case OpCode::SHIFT_LEFT:
            return rp4::OpCode::SHIFT_LEFT;
        case OpCode::SHIFT_RIGHT:
            return rp4::OpCode::SHIFT_RIGHT;
        case OpCode::BIT_AND:
            return rp4::OpCode::BIT_AND;
        case OpCode::BIT_OR:
            return rp4::OpCode::BIT_OR;
        case OpCode::BIT_XOR:
            return rp4::OpCode::BIT_XOR;
        case OpCode::BIT_NEG:
            return rp4::OpCode::BIT_NEG;
        case OpCode::SET_FIELD:
            return rp4::OpCode::SET_FIELD;
        case OpCode::COPY_FIELD:
            return rp4::OpCode::COPY_FIELD;
        default:
            break;
        }
    }
